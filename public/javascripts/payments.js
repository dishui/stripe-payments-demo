...
(async () => {
  ...
  paymentRequest.on('source', async event => {
    console.log('creating source ', event);
    try {
  ...
  paymentRequest.on('shippingaddresschange', event => {
    ...
    const supportedShippingOptions = [{
      id: 'flatReat',
  ...
  fetch('/shippingRates', {
    ...
    event.updateWith({
      status: 'success',
      shippingOptions: supportedShippingOptions
     });
  });
  /*event.updateWith({
    status: 'fail'
  ...
  console.log('can browser support payment request?', paymentRequestSupport);
  console.log('is apple pay available? ', paymentRequestSupport.applePay);
